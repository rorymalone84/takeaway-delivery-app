    <x-storefront>
        <div class="mx-auto w-4/5 p-10">
            <div class="text-center p-8">
                <h1 class="text-1xl font-bold tracking-tight text-gray-200 sm:text-1xl">Find your nearest Store</h1>
            </div>
        ...
        <div class="grid sm:grid-cols-4 gap-8 pt-20 mx-auto w-4/5">
            @foreach ($stores as $store)
                <div class="mx-auto">
                    <h2 class="text-xl text-gray-100 font-bold pb-8">
                        {{ $store->name }}
                    </h2>

                    <p class="font-thin text-xs  text-gray-100 pb-8">
                        {{ $store->address_line_1 }}
                    </p>

                    <p class="font-bold text-l  text-gray-100 pb-8">
                        {{ $store->postcode }}
                    </p>
