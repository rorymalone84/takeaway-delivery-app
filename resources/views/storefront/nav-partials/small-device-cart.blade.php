...
<a class=" hover:text-gray-200 pr-6 md:hidden text-gray-300" href="{{ route('cart') }}">
    ...
    <span class="flex absolute -mt-7 ml-3 ">
        @if (session('cartProducts'))
            ...
            <span class="relative inline-flex rounded-full h-7 w-7 bg-pink-300 text-center"><span id="totalQuantitySM"
