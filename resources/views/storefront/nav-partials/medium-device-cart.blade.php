<a class="flex items-center hover:text-gray-200 pr-6 text-gray-300" href="{{ route('cart') }}">
    ...
    <span class="flex absolute -mt-5 ml-2">
        ...
        @if (session('cartProducts'))
            ...
            <span class="relative inline-flex rounded-full h-7 w-7 bg-pink-300 text-center"><span id="totalQuantityMD"
