<x-storefront>
    <div class="grid sm:grid-cols-2 gap-2 pt-12 pb-12 sm:pt-20 mx-auto w-4/5 pb-8">
        <div class="mx-auto">
            <img 
        ...
        <div>
            ...
            <a 
                ...
                class="px-6 py-4 uppercase text-white font-bold bg-blue-600 rounded-full w-full" 
                role="button" 
                aria-pressed="true">
                Add To Cart
            </a>
