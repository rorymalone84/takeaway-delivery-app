<x-admin-layout>
    ...
    <div class="flex overflow-hidden pt-16">
        <div id="main-content" class="h-full w-full bg-gray-700 relative overflow-y-auto">
            <main>
                <div class="pt-6 px-4">
                        ...
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex-shrink-0">
                                    <span
                                        class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">£{{ $salesThisWeek }}</span>
                                    <h3 class="text-base font-normal text-gray-500">Sales this week compared to last
                                        week</h3>
                                </div>
                        ...
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                            <div class="mb-4 flex items-center justify-between">
                                <div>
                                    ...
                                    <span class="text-base font-normal text-gray-500">The most recent 10 orders</span>
                                </div>
                                <div class="flex-shrink-0">
                                    <a href="#"
                                                    ...
                                                    @foreach ($lastTenOrders as $order)
                                                        <tr class="bg-gray-50">
                                                            <td
                                                                ...
                                                                <span
                                                                    class="font-semibold">{{ $order->customer_name }}</span>
                                                            </td>
                                                            <td
                    ...
                    <div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <span
                                        class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{{ $productAmount }}</span>
                        ...
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <span
                                        class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{{ $userAmount }}</span>
                                    <h3 class="text-base font-normal text-gray-500">Number of customers</h3>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <span
                                        class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">{{ $customersThisWeek }}</span>
                    ...
                    <div class="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
                                    ...
                                    @foreach ($latestUsers as $user)
                                        <li class="py-3 sm:py-4">
                                            <div class="flex items-center space-x-4">
                                                ...
                                                <a class="inline-flex items-center text-base font-semibold text-gray-900"
                        ...
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                            <h3 class="text-xl leading-none font-bold text-gray-900 mb-10">Product Sales Overview</h3>
